...
floor.position.set(0.0, -2.2, 0.0);
floor.receiveShadow = true;
scene.add(floor);

const loader = new GLTFLoader();
const diceGltf = await loader.loadAsync('custom_die.glb');
...
const diceGltf2 = await loader2.loadAsync('glass_die_1.glb');
const dice2 = diceGltf2.scene;
const numBodies2 = 1;
const bodies2 = [];
for (let i = 0; i < numBodies2; i++) {
  const body2 = getBody(RAPIER, world, dice2);
  bodies2.push(body2);
